...
layui.define('form', function(exports) {
    ...
    Class.prototype.tree = function(elem, children) {
        ...
        layui.each(data, function(index, item) {
            var hasChild = item.children && item.children.length > 0,
                ...
                entryDiv = $(['<div data-id="' + item.id + '" class="layui-tree-set' + (item.spread ? " layui-tree-spread" : "") + (item.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">'
                    //箭头
                    ,
                    function() {
                        if (options.showLine) {
    ...
    Class.prototype.spread = function(elem, item) {
        ...
        touchOpen.on('click', function(e) {
            // console.log(touchOpen.find('i'))
            // console.log(touchOpen.prevObject.prevObject.attr('class'))
            // console.log(touchOpen.prevObject.prevObject.is('.layui-tree-spread'))
            var iconState = touchOpen.prevObject.prevObject.is('.layui-tree-spread');
            // 改变图标
            if (iconState) {
                $(touchOpen.find('i')).removeClass('active-icon');
            } else {
                $(touchOpen.find('i')).addClass('active-icon');
            }
        ...
        elemText.on('click', function() {
            ...
            if (elem.hasClass(ELEM_SPREAD)) {
                ...
                // .layui-tree-iconArrow.active-icon::after
                // console.log(options.onlyIconControl)
            } else {
                state = options.onlyIconControl ? 'close' : 'open';
                // console.log(options.onlyIconControl)
                // console.log(ELEM_SPREAD)
            }
